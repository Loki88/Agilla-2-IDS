...
implementation {
	...
	// 	new NetworkInterfaceProxy(AM_AGILLAADDRESSMSG) as Comm2,
	// 	new NetworkInterfaceProxy(AM_AGILLAADDRESSACKMSG) as Comm3;
	...
	*/
	...
	AddressMgrM.ReceiveSetBSMsg -> Comm.Receive[AM_AGILLASETBSMSG];
	AddressMgrM.ReceiveAddress -> Comm.Receive[AM_AGILLAADDRESSMSG];
	AddressMgrM.SendAddress -> Comm.AMSend[AM_AGILLAADDRESSMSG];
	AddressMgrM.ReceiveAddressAck -> Comm.Receive[AM_AGILLAADDRESSACKMSG];
	AddressMgrM.SendAddressAck -> Comm.AMSend[AM_AGILLAADDRESSACKMSG];
