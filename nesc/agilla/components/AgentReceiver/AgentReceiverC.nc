...
implementation {
	...
	// components new NetworkInterfaceProxy(AM_AGILLAACKCODEMSG) as Comm4;
	// components new NetworkInterfaceProxy(AM_AGILLAHEAPMSG) as Comm5;
	// components new NetworkInterfaceProxy(AM_AGILLAACKHEAPMSG) as Comm6;
	// components new NetworkInterfaceProxy(AM_AGILLAOPSTACKMSG) as Comm7;
	// components new NetworkInterfaceProxy(AM_AGILLAACKOPSTACKMSG) as Comm8;
	// components new NetworkInterfaceProxy(AM_AGILLARXNMSG) as Comm9;
	// components new NetworkInterfaceProxy(AM_AGILLAACKRXNMSG) as Comm10;
	...
	ReceiveStateM.Rcv_State -> Comm.Receive[AM_AGILLASTATEMSG];
	ReceiveStateM.Send_State_Ack -> Comm.AMSend[AM_AGILLAACKSTATEMSG];
	...
	ReceiveCodeM.Rcv_Code -> Comm.Receive[AM_AGILLACODEMSG];
	ReceiveCodeM.Send_Code_Ack -> Comm.AMSend[AM_AGILLAACKCODEMSG];
	...
	ReceiveHeapM.Rcv_Heap -> Comm.Receive[AM_AGILLAHEAPMSG];
	ReceiveHeapM.Send_Heap_Ack -> Comm.AMSend[AM_AGILLAACKHEAPMSG];
	...
	ReceiveOpStackM.Rcv_OpStack -> Comm.Receive[AM_AGILLAOPSTACKMSG];
	ReceiveOpStackM.Send_OpStack_Ack -> Comm.AMSend[AM_AGILLAACKOPSTACKMSG];
	...
	ReceiveRxnM.Rcv_Rxn -> Comm.Receive[AM_AGILLARXNMSG];
	ReceiveRxnM.Send_Rxn_Ack -> Comm.AMSend[AM_AGILLAACKRXNMSG];
