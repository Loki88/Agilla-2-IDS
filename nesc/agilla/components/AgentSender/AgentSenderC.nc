...
implementation {
	...
	SendStateM.Send_State	 -> Comm.AMSend[AM_AGILLASTATEMSG];
	SendStateM.SerialSend_State	 -> SerialSendComm11.AMSend;
	SendCodeM.Send_Code		 -> Comm.AMSend[AM_AGILLACODEMSG];
	SendCodeM.SerialSend_Code		 -> SerialSendComm13.AMSend;
	SendOpStackM.Send_OpStack -> Comm.AMSend[AM_AGILLAOPSTACKMSG];
	SendOpStackM.SerialSend_OpStack -> SerialSendComm15.AMSend;
	SendHeapM.Send_Heap		 -> Comm.AMSend[AM_AGILLAHEAPMSG];
	SendHeapM.SerialSend_Heap		 -> SerialSendComm17.AMSend;
	SendRxnM.Send_Rxn		 -> Comm.AMSend[AM_AGILLARXNMSG];
	SendRxnM.SerialSend_Rxn		 -> SerialSendComm19.AMSend;

	// Wire up the ReceiveMsg interfaces
	SendStateM.Rcv_Ack	 -> Comm.Receive[AM_AGILLAACKSTATEMSG];
	SendStateM.SerialRcv_Ack	 -> SerialReceiveComm12.Receive;
	SendCodeM.Rcv_Ack	-> Comm.Receive[AM_AGILLAACKCODEMSG];
	SendCodeM.SerialRcv_Ack	-> SerialReceiveComm14.Receive;
	SendOpStackM.Rcv_Ack -> Comm.Receive[AM_AGILLAACKOPSTACKMSG];
	SendOpStackM.SerialRcv_Ack -> SerialReceiveComm16.Receive;
	SendHeapM.Rcv_Ack	-> Comm.Receive[AM_AGILLAACKHEAPMSG];
	SendHeapM.SerialRcv_Ack	-> SerialReceiveComm18.Receive;
	SendRxnM.Rcv_Ack	 -> Comm.Receive[AM_AGILLAACKRXNMSG];
