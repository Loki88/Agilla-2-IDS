...
implementation {
	...
	*/
	...
	NeighborListM.SendBeacon -> Comm.AMSend[AM_AGILLABEACONMSG];
	NeighborListM.RcvBeacon -> Comm.Receive[AM_AGILLABEACONMSG];
	...
	NeighborListM.RcvGetNbrList -> Comm.Receive[AM_AGILLAGETNBRMSG];
	NeighborListM.SendGetNbrList -> Comm.AMSend[AM_AGILLAGETNBRMSG];
	NeighborListM.SerialRcvGetNbrList -> SerialReceiveComm5.Receive;

	//NeighborListM.SendNbrListTimer -> TimerC.Timer[unique("Timer")];
	NeighborListM.SendNbrList -> Comm.AMSend[AM_AGILLANBRMSG];
	NeighborListM.RcvNbrList	-> Comm.Receive[AM_AGILLANBRMSG];
