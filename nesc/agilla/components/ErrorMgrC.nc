...
implementation {
	...
	components LedsC; 
	components NetworkInterfaceProxy as Comm; //GenericComm;
	...
	ErrorMgrM.SendError -> Comm.AMSend[AM_AGILLAERRORMSG];
	ErrorMgrM.ReceiveError -> Comm.Receive[AM_AGILLAERRORMSG];
