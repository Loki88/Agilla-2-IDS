...
implementation
{
	...
	RemoteTSOpMgrM.Rcv_Req -> Comm.Receive[AM_AGILLATSREQMSG];
	RemoteTSOpMgrM.Rcv_Res -> Comm.Receive[AM_AGILLATSRESMSG];
	RemoteTSOpMgrM.Rcv_GRes -> Comm.Receive[AM_AGILLATSGRESMSG];
	...
	RemoteTSOpMgrM.Send_Req -> Comm.AMSend[AM_AGILLATSREQMSG];
	RemoteTSOpMgrM.SerialSend_Req -> SerialSendComm4.AMSend;
	RemoteTSOpMgrM.Send_Res -> Comm.AMSend[AM_AGILLATSRESMSG];
	RemoteTSOpMgrM.SerialSend_Res -> SerialSendComm5.AMSend;
	RemoteTSOpMgrM.Send_GRes -> Comm.AMSend[AM_AGILLATSGRESMSG];
